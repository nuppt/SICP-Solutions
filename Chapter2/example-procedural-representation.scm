;; try to implement pair type in procedural representation
(define (cons x y)
  (define (dispatch m)
    (cond ((= m 0) x)
	  ((= m 1) y)
	  (else (error "Argument is not 0 or 1: CONS:" m))))
  dispatch)
...
;; Test by example-arithmetic-operations-for-rational-numbers.scm
;; --------------------------------------------------------------
;; In theory,
